...
Note:APPROVED WITH BINDING EXECUTION CLARIFICATIONS

Ik, Delroy, keur het herziene VZ Juspol Gen Frontend Completion Master Plan 001 rev.001 goed en release uitsluitend de voorgestelde geconsolideerde Build Mode-batch LFB-104, met deze bindende verduidelijkingen:

1. De zes categoriebeelden moeten elk visueel onderscheidend zijn, maar samen één consistente professionele VZ-beeldfamilie vormen.

2. Voor alle drie homepage-heroafbeeldingen bevindt het primaire onderwerp/focus zich rechts. De linkerzijde blijft rustig en voldoende donker/contrastvol als veilige ruimte voor de bestaande Liviza-tekst en CTA’s. Geen tekst wordt in afbeeldingen ingebakken.

3. CP1–CP7 zijn verplichte interne validatie-, evidence- en rollbackmomenten. Wanneer Lovable technisch één eindcommit per uitvoering maakt, hoeven geen kunstmatige losse commits te worden geforceerd. De checkpoints moeten wel afzonderlijk aantoonbaar zijn in het eindrapport en manifest.

4. De rustige abstracte page-top moet de witte header, navigatie, contactinformatie, paginatitel en breadcrumb op alle vastgelegde viewports leesbaar houden. Bij onvoldoende contrast: STOP en corrigeren binnen de page-topcompositie; verander de goedgekeurde Liviza-headerstructuur niet.

5. Alleen de reeds vastgelegde 15 Aanvraaghulp-uitkomsten mogen worden uitgevoerd. De zes diensten zonder gekoppeld governed PDF-record tonen geen vervangend of bedacht document.

6. Geen nieuws- of FAQ-content genereren. Deze routes behouden hun governed empty state.

Alle overige scopegrenzen, STOP-condities, verboden surfaces, tests en evidence-eisen uit het herziene plan blijven volledig bindend.

Niet vrijgegeven: database, Supabase/Lovable Cloud, authenticatie, persoonsgegevens, uploads, betalingen, e-mail, /admin/*, PDF-wijzigingen, dependencies, publicatie/deployment, GitHub-acties en verwijdering van oude VZ-sites.  
