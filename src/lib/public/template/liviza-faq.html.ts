// Liviza `faq.html` <body> markup, ported 1:1 from the purchased template.
      ...
      <div class="page-wrapper">
														...
														<ul class="navigation clearfix">
															...
															<li class="dropdown">
																...
																<ul>
																	...
																	<li class="active"><a href="/veelgestelde-vragen">Faq</a></li>
																</ul>
															</li>
															<li class="dropdown">
																<a href="#">Blog</a>
		...
		<div class="page-content">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							...
							<p class="pb-2">We provide immigration service in all over country and universities. Sed semper sed tellus in ultrices. Nam hendrerit elit vel urna fermentum congue. Aenean varius euismod quam sed ultricesNam hendrerit elit vel urna fermentum congue. </p>
								...
								<div class="accordion-item active">
									...
									<div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
										<div class="accordion-body">
											Now were up in the big leagues getting’ our turn at bat. And when the odds are against him and their dangers work to do Duis aute irure dolor.Stet clita kasd gubergren, no sea takimata sanctus est.
										</div>
									</div>
								</div>
								<div class="accordion-item">
									<h2 class="accordion-header" id="headingTwo">
										<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
											Do I qualify for the Student Visa?
											<i class="pbmit-controls-icon-chevron"></i>
										</button>
									</h2>
								...
								<div class="accordion-item">
									<h2 class="accordion-header" id="headingThree">
										<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
											What if I'm do for Visa Immigration?
											<i class="pbmit-controls-icon-chevron"></i>
										</button>
									</h2> 
								...
								<div class="accordion-item">
									<h2 class="accordion-header" id="headingfour">
										<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapsefour" aria-expanded="false" aria-controls="collapsefour">
											How does my passport have to valid for a U. S. visa?
											<i class="pbmit-controls-icon-chevron"></i>
										</button>
									</h2>
								...
								<div class="accordion-item">
									<h2 class="accordion-header" id="headingFive">
										<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
											Does your immigration offer a money-back guarantee?
											<i class="pbmit-controls-icon-chevron"></i>
										</button>
									</h2> 
            ...
            <section class="section-faq">
				<div class="container">
					<h3 class="pbmit-title mb-3">LIVIZA EXPERT</h3>
					<p class="pb-2">We provide immigration service in all over country and universities. Sed semper sed tellus in ultrices. Nam hendrerit elit vel urna fermentum congue. Aenean varius euismod quam sed ultricesNam hendrerit elit vel urna fermentum congue. </p>
					<div class="row">
						<div class="col-12">
							<div class="accordion" id="accordionExample2">
								<div class="accordion-item active">
									...
									<div id="collapseOne1" class="accordion-collapse collapse show" aria-labelledby="headingTwo1"
